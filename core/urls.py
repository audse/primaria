...
urlpatterns = [
    ...
    # users
    url(r'^profile/(?P<username>[\w-]+)/$', 'core.views.profile_page', name='profile_page'),
    ...
    url(r'^friends/(?P<username>[\w-]+)/send/$', 'core.views.send_friend_request', name='send_friend_request'),
    url(r'^friends/(?P<username>[\w-]+)/accept/$', 'core.views.accept_friend_request', name='accept_friend_request'),
    url(r'^friends/(?P<username>[\w-]+)/reject/$', 'core.views.reject_friend_request', name='reject_friend_request'),
    url(r'^friends/(?P<username>[\w-]+)/remove/$', 'core.views.remove_friend', name='remove_friend'),

    # registration
    url(r'^register/$', 'core.views.register_page', name='register_page'),
    url(r'^register/processing/$', 'core.views.register', name='register'),
    url(r'^register/success/$', 'core.views.successful_register_page', name='successful_register_page'),
    ...
    url(r'^bonus/claimed/$', 'core.views.claimed_login_bonus_page', name='claimed_login_bonus_page'),
    ...
    url(r'^create/(?P<animal>[A-Za-z]+)/$', 'core.views.create_pet_step_2', name='create_pet_step_2'),
    url(r'^create/(?P<animal>[A-Za-z]+)/name/$', 'core.views.create_pet_step_3', name='create_pet_step_3'),
    url(r'^creating/$', 'core.views.create_pet', name='create_pet'),
    url(r'^creating/success/$', 'core.views.successful_create_pet_page', name='successful_create_pet_page'),
