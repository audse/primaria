...
def delete_reply(request):
	if request.user.is_authenticated() and request.user.is_staff:
		...
		reply.save()
		message = Message.objects.create(receiving_user=reply.user, subject="Your Reply Has Been Deleted", text="Your reply has been deleted, for the reason: \"" + deleted_reason + "\". Please refer to the site rules before posting a reply.")
