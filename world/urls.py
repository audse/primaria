...
urlpatterns = [
    ...
    url(r'^hospital/appointment/$', 'world.views.make_hospital_appointment', name='make_hospital_appointment'),
    url(r'^hospital/pickup/$', 'world.views.pickup_hospital_medicine', name='pickup_hospital_medicine'),

    url(r'^pound/$', 'world.views.pound_page', name='pound_page'),
    url(r'^pound/release/$', 'world.views.give_up_pet', name='give_up_pet'),
    url(r'^pound/adopt/(?P<adopt>[\w-]+)$', 'world.views.adopt_from_pound', name='adopt_from_pound'),
    ...
    url(r'^games/wheel/serendipity/$', 'world.views.wheel_serendipity_page', name='wheel_serendipity_page'),
    url(r'^games/wheel/plush/$', 'world.views.wheel_plush_page', name='wheel_plush_page'),
    url(r'^games/(?P<game>[A-Za-z]+)/send/$', 'world.views.send_score', name='send_score'),
    ...
    url(r'dump/(?P<pk>[0-9]+)/take/$', 'world.views.take_from_dump', name='take_from_dump'),
    url(r'dump/add/$', 'world.views.dump_item', name='dump_item'),

    url(r'quarry/$', 'world.views.quarry_page', name='quarry_page'),
    url(r'quarry/purchase/rod/$', 'world.views.purchase_dowsing_rod', name='purchase_dowsing_rod'),
    url(r'quarry/upgrade/rod/$', 'world.views.upgrade_dowsing_rod', name='upgrade_dowsing_rod'),
    url(r'quarry/dowse/$', 'world.views.dowse', name='dowse'),
    url(r'quarry/trade/(?P<crystal>[\w-]+)/$', 'world.views.trade_crystals', name='trade_crystals'),

    url(r'restricted/$', 'world.views.restricted_area_page', name='restricted_area_page'),
    url(r'restricted/update/(?P<crystal>[\w-]+)/$', 'world.views.update_card', name='update_card'),
    url(r'restricted/activate/$', 'world.views.activate_card', name='activate_card'),
    url(r'restricted/machine/$', 'world.views.restricted_machine', name='restricted_machine'),


    # DAILIES

    url(r'meatloaf/$', 'world.views.almighty_meatloaf_page', name='almighty_meatloaf_page'),
    url(r'meatloaf/take/$', 'world.views.take_from_meatloaf', name='take_from_meatloaf'),
    ...
    url(r'vending/(?P<pk>[0-9]+)/vend/$', 'world.views.vending_machine', name='vending_machine'),
]
