                        ...
                        if inventory.item.url.replace("-potion", "") == "hunger":
                            ...
                            if stat == 1:
                                ...
                                if pet.hunger <= 1:
                                    ...
                                    pet.hunger == 5
                                pet.save()
                                request.session['results'] += " Its' hunger changes by a bit."
                            elif stat == 2:
                                pet.wellness += change
                                if pet.wellness <= 1:
                                    pet.wellness == 1
                                    ...
                                    pet.wellness == 5
                                pet.save()
                                request.session['results'] += " Its' wellness changes by a bit."
                            elif stat == 3:
                                ...
                                if pet.happiness <= 1:
                                    ...
                                    pet.happiness == 5
                                pet.save()
                                request.session['results'] += " Its' happiness changes by a bit."
                            elif stat == 4:
                                ...
                                if pet.happiness <= 1:
                                    ...
                                    pet.happiness == 5
                                pet.save()
                                request.session['results'] += " All of its' stats change a bit."
                            inventory.delete()
                            return redirect(potion_results_page)
