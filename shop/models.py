...
class Trade(models.Model):
    original_trade = models.ForeignKey(
        "self", related_name="original", blank=True, null=True, on_delete=models.CASCADE
    )
    sending_user = models.ForeignKey(
        "auth.User", related_name="trade_sending_user", on_delete=models.CASCADE
    )
